...
export const api = {
  ...
  tailorForgotPassword: (identifier, channel) => request("/v1/auth/forgot-password", { method: "POST", body: JSON.stringify({ identifier, channel }) }),
  tailorResetPassword: (payload) => request("/v1/auth/reset-password", { method: "POST", body: JSON.stringify(payload) }),
  customerForgotPassword: (identifier, channel) => request("/v1/auth/customer-forgot-password", { method: "POST", body: JSON.stringify({ identifier, channel }) }),
  ...
  bookingInvoice: (id) => request(`/v1/bookings/${encodeURIComponent(id)}/invoice`),
  resendBookingInvoiceEmail: (id) => request(`/v1/bookings/${encodeURIComponent(id)}/invoice/email`, { method: "POST" }),
  ...
  bookingTrackTicket: (id) => request(`/v1/bookings/${encodeURIComponent(id)}/track-ticket`, { method: "POST" }),
  ...
  presignTailorProfileImage: (payload) => request("/tailor/profile-image/presign", { method: "POST", body: JSON.stringify(payload) }),
  completeTailorProfileImage: (payload) => request("/tailor/profile-image/complete", { method: "POST", body: JSON.stringify(payload) }),
  ...
  presignTailorMedia: (payload) => request("/tailor/media/presign", { method: "POST", body: JSON.stringify(payload) }),
  completeTailorMedia: (payload) => request("/tailor/media/complete", { method: "POST", body: JSON.stringify(payload) }),
