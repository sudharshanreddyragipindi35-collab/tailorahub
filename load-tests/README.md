...
Profiles are `smoke`, `baseline` (50), `normal` (100), `growth` (250), `release` (500), `high` (1,000), `spike`, and `soak`. `SOAK_VUS` and `SOAK_DURATION` override the soak defaults of 100 users and four hours.
